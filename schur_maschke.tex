...
\end{minipage}
\footnotetext{Man sagt ja, ein Mathematiker sei erst dann wirklich erfolgreich, wenn ein Lemma nach ihm benannt wurde...}
...
\begin{theorem}[Satz von Maschke\footnote{Heinrich Maschke, 1853--1908, dt. Mathematiker}]\label{darstellungen:maschke}
Ist $G$ eine kompakte Gruppe und $T$ eine stetige, endlich-dimensionale Darstellung von $G$, dann ist $T$ \udot{halbeinfach}, d.h. $T$ ist die direkte Summe von einigen seiner einfachen Unterdarstellungen:
\begin{enumerate}
...
\begin{corollary}[Umkehrung des Lemmas von Schur]\label{darstellungen:schur_umkehrung}
