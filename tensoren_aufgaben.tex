...
\begin{subproblem}
Zeige, dass Skalarerweiterung die Dimension erhält in folgendem Sinne: $\dim_\IR(V) = \dim_\IC(V_\IC)$ (Wer es für nötig erachtet, darf sich wieder \enquote{für endlich-dimensionale $V$} dazudenken)
\end{subproblem}
