...
\subsection{Beispiele für Abbildungen zwischen Tensoren}

\begin{definition}[Spur nehmen von einem Tensor]
Sei $v_1 \cdots \otimes \cdots v_n$ ein reiner Tensor aus $V^{\otimes n}$. Dann definiert die Abbildung
\[\tr_{kl} : 
\left\lbrace\begin{array}{rcl}
...
\end{array}\right.
\]
die \udot{Spur zwischen dem $k$-ten und $l$-ten Faktor} des Tensors. Für einen allgemeinenn Tensor ist die Spur als lineare Fortsetzung der obigen Abbildung gegeben.
\end{definition}
